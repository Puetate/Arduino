...
const char* ssid = "PuetaWifi"; //Enter SSID
const char* password = "pueta@localhost:8080"; //Enter Password

const char* websockets_server_host = "192.168.115.176"; //Enter server address
//const char* websockets_server_host = "serverip_or_name"; //Enter server address

#define WEBSOCKETS_PORT     3000
